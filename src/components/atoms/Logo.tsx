    ...
    <div className={`flex items-center ${s.gap}`}>
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-br from-primary via-cyan-400 to-accent p-1.5 md:p-2 rounded-lg">
          <Sparkles size={s.icon} className="text-background" strokeWidth={2.5} />
        </div>
      </div>
      {showText && (
        <div className="flex flex-col leading-none">
          <span className={`font-bold ${s.text} bg-gradient-to-r from-primary via-cyan-300 to-accent bg-clip-text text-transparent`}>
            Pixis AI
          </span>
